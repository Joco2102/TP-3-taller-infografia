...
// las fotos van al lado del index. si alguien las guarda adentro de una
// carpeta img/, la busco ahí antes de darla por perdida
...
const marca = n => document.documentElement.style.setProperty('--marca', 'url("' + n + '")');
const prueba = new Image();
prueba.onload  = () => marca('logo.png');
prueba.onerror = () => marca('logo.png');
prueba.src = 'logo.png';
...

  {
    ...
    hijos:[
      ...
      { id:'dartmouth', boton:'1956 — DARTMOUTH', tipo:'historia',
        anio:'1956', foto:'h-dartmouth.jpg',
        ...
        gente:[
          { id:'mccarthy', nombre:'John McCarthy', foto:'p-mccarthy.jpg',
          ...
          { id:'minsky', nombre:'Marvin Minsky', foto:'p-minsky.jpg',
          ...
          { id:'shannon', nombre:'Claude Shannon', foto:'p-shannon.jpg',
          ...
          { id:'rochester', nombre:'Nathaniel Rochester', foto:'p-rochester.jpg',
      ...
      { id:'perceptron', boton:'1957 — PERCEPTRÓN', tipo:'historia',
        anio:'1957', foto:'h-perceptron.jpg',
...

  {
    ...
    hijos:[
      { id:'como-funciona', boton:'Cómo funciona', tipo:'secuencia',
        ...
        pasos:[
          { pie:'Entrada',         img:'gato.jpg' },
          { pie:'Análisis líneas', img:'gato-lineas.png' },
          { pie:'Análisis formas', img:'gato-formas.png' },
          { pie:'Gato (98%)',      img:'gato.jpg', final:true }
        ] }
    ]
  }
];
...
function pintarSupervisado(w, n){
  ...
  const casos = [
    { arte:'<img src="perro-foto.jpg" alt="">', pone:'Perro', bien:'Perro' },
    { arte:'<img src="perro-foto.jpg" alt="">', pone:'Gato',  bien:'Perro' },
    { arte:'<img src="gato-foto.jpg" alt="">',  pone:'Gato',  bien:'Gato' }
  ];
  casos.forEach(c=>{
    const f = document.createElement('figure');
...
function pintarNoSupervisado(w, n){
  ...
  const f = document.createElement('figure');
  f.className = 'muestra';
  f.innerHTML = '<div class="lienzo"><img src="gato-foto.jpg" alt=""></div>' +
...
function pintarMapa(w, n){
  ...
  caja.innerHTML = '<img src="mapa.png" alt="Mapa del mundo con los focos de desarrollo de modelos de IA">';
