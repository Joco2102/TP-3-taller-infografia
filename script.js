...
// las fotos salen de imagenes.js. si ese archivo no está, las busca en la
// carpeta img como antes, así la página anda de las dos formas
if (typeof IMG === 'undefined') {
  window.IMG = new Proxy({}, { get: (_, nombre) => 'img/' + String(nombre) });
}
if (!getComputedStyle(document.documentElement).getPropertyValue('--marca').trim()) {
  document.documentElement.style.setProperty('--marca', 'url("' + IMG['logo.png'] + '")');
}
